# Project 2 - Ames Housing Data and Kaggle Challenge - To Fit or Not to Fit
...
- Jupyter Notebook or any other Python IDE for running the code
- The following Python libraries:
  - pandas for data manipulation and analysis
  - matplotlib or seaborn for data visualization
  - numpy for numerical computing
  - sklearn for  machine learning, regression modelling
  - jupyterlab for running Jupyter Notebooks


## Purpose
The purpose of this project is to analyze the Ames Housing dataset and develop a machine learning model that accurately predicts the sale price of single-family homes in Ames, Iowa. This regression model aims to achieve a low Root Mean Squared Error (RMSE), indicating its ability to predict sale prices close to the true values. Additionally, the model will focus on interpretability by identifying important variables and metrics that influence sale price through feature engineering. The insights gained from the most accurate model will provide valuable information for real estate professionals, investors, and homeowners in the Ames area, facilitating informed decision-making and contributing to a better understanding of the factors influencing housing prices.

### Methods
Regression Modeling Candidates:
...
#### Kaggle Score/Standing
Despite a 4 hour late submission for the challenge, was able to finally get a commendable score for RMSE!
> - 27391.35442 (**3rd best RMSE score**)

#### Next steps
    - Come back to this repostory during the July break and try to debug and re-evaluate the dummification process.
    - Even though Kaggle gave a great score, dummy variable process seemed to affect fitting of the models.
    - Maybe don't dummify every single categorical feature. Choose the ones that seem most relevant.    
    - Ultimately, the method for automating every aspect of this project to generalized functions might be a fun challenge to address in the future.
    - Investigate how to combine the categorical features with numerical features to build more granular plots with legends and colormaps.

#### Limitations
    - Did not use any dummy variables in modelling process.
    - Need to find a way to address dummy variables in a more precise manner rather than applying the method to all categories.
    - Try to use cross validation in the future.
...
03_Model_Benchmarks                - https://git.generalassemb.ly/manuelfloresds/project-2/blob/main/code/03_Model_Benchmarks.ipynb
05_Production_Model_and_Submission - https://git.generalassemb.ly/manuelfloresds/project-2/blob/main/code/05_Production_Model_and_Submission.ipynb

project2-kaggle                    - https://github.com/mtahir19/Ames-Housing-Data-and-Kaggle-Challenge/blob/main/project2-kaggle.ipynb